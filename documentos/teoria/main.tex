...
Las estructuras algebraicas son sistemas matemáticos formales compuestos por uno o más conjuntos no vacíos, los cuales están dotados de una o varias operaciones (leyes de composición interna o externa) y, en ocasiones, de elementos singulares y relaciones, que satisfacen un conjunto riguroso de axiomas.
...
\begin{itemize}
    \item \textbf{Semigrupo:} Es la estructura más básica, consistente en un conjunto dotado de una única operación binaria que cumple inexcusablemente con la propiedad asociativa.
    \item \textbf{Monoide:} Es una extensión del semigrupo que exige, además de la asociatividad, la existencia de un elemento neutro (o identidad) dentro del conjunto.
    \item \textbf{Grupo:} Es un monoide en el cual se cumple la propiedad de los inversos; es decir, cada elemento del conjunto posee un simétrico o inverso respecto a la operación. En el caso de que la operación también cumpla con la ley conmutativa, la estructura se clasifica como grupo abeliano.
\end{itemize}

\textbf{Estructuras con dos operaciones internas:}

\begin{itemize}
    \item \textbf{Anillo:} Es un sistema algebraico provisto de dos operaciones (convencionalmente denominadas suma y producto). Para poseer esta estructura, el conjunto debe conformar un grupo abeliano bajo la primera operación, constituir un semigrupo bajo la segunda, y vincular ambas leyes de manera que el producto sea distributivo respecto a la suma.
    \item \textbf{Cuerpo (o Campo):} Representa un grado superior de regularidad algebraica. Se trata de un anillo conmutativo y con unidad (neutro multiplicativo) en el cual absolutamente todo elemento, a excepción del neutro aditivo (cero), posee un inverso multiplicativo. Dicho de otra manera, los elementos no nulos de un cuerpo forman por sí mismos un grupo abeliano bajo la operación del producto.
    \item \textbf{Álgebra de Boole:} Constituye un conjunto dotado de dos operaciones que gozan de plena simetría axiomática: ambas son asociativas y conmutativas, ambas son distributivas la una respecto de la otra, ambas poseen elementos neutros distintos, y cada elemento del conjunto admite un complementario.
\end{itemize}
...
Los elementos singulares son componentes específicos de un conjunto que desempeñan un rol único y distinguido bajo una ley de composición determinada. A diferencia de los elementos genéricos, los singulares poseen propiedades invariantes que definen el comportamiento global de la estructura.
...
Las leyes de composición son las reglas fundamentales que permiten relacionar u operar los elementos de los conjuntos matemáticos. Se clasifican en:
\begin{itemize}
    \item Interna
    \item Externa
\end{itemize}
...
\subsection{Ley de Composición Interna: Propiedades Basicas y de Elementos Singulares} 
...
\textbf{Subgrupo:} Se puede definir de manera muy resumida como un grupo dentro de otro grupo
\bigskip
...
\subsubsection{Cuerpo (o Campo)}
\label{sec:cuerpo-campo}    
